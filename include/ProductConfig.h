...
constexpr pony::FuncMode outputMode = pony::FuncMode::LedPulse;
...
static_assert(pulseDurationMillis >= pony::pulseMinMillis && pulseDurationMillis <= pony::pulseMaxMillis,
              "Pulse duration must be within the supported range");
